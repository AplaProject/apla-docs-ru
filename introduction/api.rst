...
==============================
**GET** Возвращает список контрактов. Можно указать смещение и количество запрашиваемых контрактов. Если нужны глобальные контракты, то следует добавить параметр *global*. Также можно указать смещение и количество получаемых элементов.
