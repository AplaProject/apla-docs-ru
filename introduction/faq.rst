...
4. Чем отличается платформа от других публичных блокчейн платформ, у которых есть встроенный механизм исполнения смарт-контрактов, таких как Ethereum, Qtum и еще только проектируемых Tezos и EOS?
...
8. Каждый ли узел сети может быть валидирующим?
  - Нет в сети может быть фисированное количество валидирующих узлов.
...
10. Что такое экосистемы платформы?
...
15. Что такое приложение платформы?
...
18. Могут ли контракты плафтформы обращаться к данным с использованием сторонних API-интерфейсов?
...
33. Какие новые функции будут реализованы на платформе в будущем?
...
36. Каким вам видится будущее платормы?
