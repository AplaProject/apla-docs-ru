...
* **$auth_token** - токен авторизации, который можно использовать в VDE контрактах. Можно использовать при вызове контрактов через api c помощью функции **HTTPRequest**. Например,
