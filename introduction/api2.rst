...
balance
==============================
**GET** Получить баланс указанного кошелька в текущей экосистеме.  В параметре *amount* возвращается сумма в кошельке в минимальных единицах, а в параметре *money* - возвращается это же величина в EGS.
...
* *wallet* - Номер кошелька. Может быть представлен в любом формате - int64, uint64, XXXX-...-XXXX.    
