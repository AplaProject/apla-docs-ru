...
* **Комментарии** - имеется два вида комментариев. 

   * До конца строки. Например, // это комментарирй до конца строки
   * Комментарий между слешами со звездочками. Например, */* Этот комментарий может быть на несколько строк */*.

* **Идентификатры** - имена переменных и функций, которые состоят из латинских букв, UTF-8 символов, цифр и знака подчеркивания. Они могут начинаться с буквы, подчёркивания, @ и $. 
