...
==============================
Функция условная конструкция, позволяющая выводить разные фрагменты  шаблона страницы в зависимости от истинности или ложности условия. Конструкции **If** могут быть вложенными, например,
