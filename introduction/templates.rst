...
ImageInput(id) 
==============================
Функция вставляет на страницу кнопку для загрузки изображения. Необходимо указать имя идентификатора *id* для скрытого *textarea*, куда будeт записано выбранное изображение в формате base64. При это картинка отобразится рядом с кнопкой.
