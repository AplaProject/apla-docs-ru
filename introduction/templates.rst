...
ImageInput(id) 
==============================
Функция вставляет на страницу кнопку для загрузки изображения. Необходимо указать имя идентификатора *id* для скртого *textarea*, куда будeт записано выбранное изображение в формате base64.
