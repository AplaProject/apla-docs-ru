...
Документация содержит описание |project_name| — блокчейн-платформы для построения цифровых экосистем.
...
|project_name| основан на коде блокчейна криптовалюты DCoin, созданной в 2011 году основателем проекта. 
